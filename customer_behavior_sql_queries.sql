...
--Q5.Do subscribed customers spend more? compare average spend and total revenue between subscribers and non-non subscribers?
select subscription_status,
COUNT (customer_id) as total_customber,
